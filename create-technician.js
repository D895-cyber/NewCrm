...
async function createTechnician() {
  try {
    ...
    const technicianData = {
      ...
      password: 'tech123', // Change this to a secure password
      role: 'technician',
      isActive: true,
      profile: {
        firstName: 'John',
    ...
    if (existingUser) {
      console.log('⚠️  Technician user already exists!');
      ...
      readline.question('Do you want to delete and recreate this user? (yes/no): ', async (answer) => {
        if (answer.toLowerCase() === 'yes' || answer.toLowerCase() === 'y') {
          ...
          // Create new user
          const newUser = new User(technicianData);
          await newUser.save();
          ...
          console.log('🔑 Password: ', technicianData.password);
